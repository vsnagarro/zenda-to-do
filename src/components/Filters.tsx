...
const Filters = ({ $showFilter, $setShowFilter, $valueFilter, $setValueFilter, $showSort, $setShowSort, $valueSort, $setValueSort }: FiltersProps) => {
  return (
    <Div>
        ...
        <button type="button" onMouseEnter={() => $setShowFilter(true)} className={$showFilter ? "active" : ""}>
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              strokeWidth="0.5625"
            />
            <path d="M0.265625 2.19995H2.14062M12.2656 2.19995H4.39062" stroke="white" strokeWidth="0.5625" />
            <path d="M0.265625 6.69995H8.14062M12.2656 6.69995H10.3906" stroke="white" strokeWidth="0.5625" />
            <path d="M0.265625 11.2H5.14332M12.2656 11.2H7.39062" stroke="white" strokeWidth="0.5625" />
            <path
      ...
      <div onMouseLeave={() => $setShowSort(false)}>
        <button type="button" onMouseEnter={() => $setShowSort(true)} className={$showSort ? "active" : ""}>
          ...
          <Dropdown $show={$showSort} $value={$valueSort} $onChangeValue={$setValueSort} $items={["Newest", "Oldest"]} />
        </button>
      </div>
    </Div>
  );
